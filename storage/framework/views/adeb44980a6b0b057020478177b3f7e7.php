            ...
            <div class="flex items-center justify-between w-full px-4 py-1 mx-auto flex-wrap-inherit">
                <nav>
                    ...
                    <ol class="flex flex-wrap pt-1 mr-12 bg-transparent rounded-lg sm:mr-16">
                        ...
                        <li class="text-sm pl-2 capitalize leading-normal text-slate-700 before:float-left before:pr-2 before:text-gray-600 before:content-['/']" aria-current="page">Categories
                        </li>
                    </ol>
                    <h6 class="mb-0 font-bold capitalize">Categories</h6>
                </nav>
                ...
                <div class="flex items-center mt-2 grow sm:mt-0 sm:mr-6 md:mr-0 lg:flex lg:basis-auto">
                    ...
                    <ul class="flex flex-row justify-end pl-0 mb-0 list-none md-max:w-full">
                      ...
                      <a class="inline-block px-8 py-2 mb-0 mr-4 text-xs font-bold text-center uppercase align-middle transition-all bg-transparent border border-solid rounded-lg shadow-none cursor-pointer leading-pro border-fuchsia-500 ease-soft-in hover:scale-102 active:shadow-soft-xs text-fuchsia-500 hover:border-fuchsia-500 active:bg-fuchsia-500 active:hover:text-fuchsia-500 hover:text-fuchsia-500 tracking-tight-soft hover:bg-transparent hover:opacity-75 hover:shadow-none active:text-white active:hover:bg-transparent" target="_blank" href="https://www.creative-tim.com/builder/soft-ui?ref=navbar-dashboard&amp;_ga=2.76518741.1192788655.1647724933-1242940210.1644448053">Online Builder</a>
                        ...
                        <li class="flex items-center">
                            <button data-bs-toggle="modal" data-bs-target="#addModal" style="background-color: steelblue; padding: 8px 12px" class="bg-slate-950 text-xs rounded-1.8 py-1.4 inline-block whitespace-nowrap text-center align-baseline font-bold uppercase leading-none text-white">
                                Add
                            </button>
                        </li>
        ...
        <div class="w-full px-6 py-6 mx-auto">
            ...
            <div class="flex flex-wrap -mx-3">
                <div class="flex-none w-full max-w-full px-3">
                    <div class="relative min-w-0 mb-6 break-words bg-white border-0 border-transparent border-solid shadow-soft-xl rounded-2xl bg-clip-border">
                        <form class="p-4" action="/admin/roles" method="POST">
                            <?php echo csrf_field(); ?>
                            <div class="mb-3">
                            ...
                            <div class="row row-gap-2 mb-4">
                                <?php $__currentLoopData = $routes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $route): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="col-4">
                                        <input type="checkbox" name="routes[]" value="<?php echo e($route['id']); ?>" class="form-check-input"> <?php echo e($route['name']); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\Youcode\Documents\PHP_PROJECTS\adidas\resources\views/back/roles.blade.php ENDPATH**/ ?>
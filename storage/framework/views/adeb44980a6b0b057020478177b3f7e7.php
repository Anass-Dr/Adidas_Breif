                ...
                <ul class="flex flex-row justify-end pl-0 mb-0 list-none md-max:w-full">
                    ...
                    <li class="flex items-center">
                        <button data-bs-toggle="modal" data-bs-target="#addModal"
                                style="background-color: steelblue; padding: 8px 12px"
                                class="bg-slate-950 text-xs rounded-1.8 py-1.4 inline-block whitespace-nowrap text-center align-baseline font-bold uppercase leading-none text-white">
                            Add
                        </button>
                    </li>
    ...
    <div class="w-full px-6 py-6 mx-auto">
        ...
        <div class="flex flex-wrap -mx-3">
            <div class="flex-none w-full max-w-full px-3">
                <div
                    class="relative min-w-0 mb-6 break-words bg-white border-0 border-transparent border-solid shadow-soft-xl rounded-2xl bg-clip-border">
                    <form class="p-4" action="/admin/roles" method="POST">
                        ...
                        <div class="row row-gap-2 mb-4">
                            <?php $__currentLoopData = $routes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $route): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-4">
                                    <input type="checkbox" name="route_id" class="form-check-input"> <?php echo e($route['name']); ?>
...
<?php echo $__env->make('layouts.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Youcode\Documents\PHP_PROJECTS\adidas\resources\views/back/roles.blade.php ENDPATH**/ ?>
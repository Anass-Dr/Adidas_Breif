            ...
            <div class="flex-none w-full max-w-full px-3">
                <div
                    ...
                    <div class="flex-auto px-0 pt-0 pb-2">
                        <form class="p-4" action="<?php echo e(route('categories.update', $category->id)); ?>" method="post">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('PUT'); ?>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="description" class="form-control" required><?php echo e($category->description); ?></textarea>
                                </div>
...
<?php /**PATH C:\Users\Youcode\Documents\PHP_PROJECTS\adidas\resources\views/back/category.blade.php ENDPATH**/ ?>
            ...
            <div class="flex-none w-full max-w-full px-3">
                <div
                    ...
                    <div class="flex-auto px-0 pt-0 pb-2">
                        <form class="p-4" action="<?php echo e(route('users.update', $user->id)); ?>" method="post">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('PUT'); ?>
                                <div class="mb-3">
                                    <label class="form-label">Userame</label>
                                    <input type="text" class="form-control" value="<?php echo e($user->username); ?>" required disabled>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Email</label>
                                    <input type="email" class="form-control" value="<?php echo e($user->email); ?>" required disabled>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Role</label>
                                    <select name="role_id" class="form-control" required>
                                        <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($role->id); ?>" <?php if($user->role->id === $role->id): ?> <?php echo e('selected'); ?> <?php endif; ?> ><?php echo e($role->name); ?></option>
...
<?php /**PATH C:\Users\Youcode\Documents\PHP_PROJECTS\adidas\resources\views/back/user.blade.php ENDPATH**/ ?>
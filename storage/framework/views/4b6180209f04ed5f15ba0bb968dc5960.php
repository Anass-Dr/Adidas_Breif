...
<body>
    ...
    <?php if(session()->has('status')): ?>
        <div id="toast" class="show">
            <div id="img">Icon</div>
            <div id="desc"><?php echo e(session('status')); ?></div>
        </div>
    <?php endif; ?>
...
<?php echo $__env->make('layouts.front.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Youcode\Documents\PHP_PROJECTS\adidas\resources\views/auth/password_reset.blade.php ENDPATH**/ ?>
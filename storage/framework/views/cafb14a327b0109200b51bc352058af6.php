				...
				<div class="col-lg-6">
					<div class="login_box_img">
						...
						<div class="hover">
							...
							<p>Log in to continue to your account and explore new advancements.</p>
							<a class="primary-btn" href="registration.html">Log In</a>
						</div>
					</div>
				</div>
				<div class="col-lg-6">
					<div class="login_form_inner">
						...
						<form class="row login_form" action="/register" method="post" id="contactForm">
							...
							<div class="col-md-12 form-group">
								<input type="text" class="form-control" id="username" name="username" placeholder="Username" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Username'" value="<?php echo e(old('username')); ?>" required>
							</div>
							<div class="col-md-12 form-group">
								<input type="email" class="form-control" id="email" name="email" placeholder="Email" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Email'" value="<?php echo e(old('email')); ?>" required>
							</div>
							<div class="col-md-12 form-group">
...
<?php echo $__env->make('layouts.front.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Youcode\Documents\PHP_PROJECTS\adidas\resources\views/auth/register.blade.php ENDPATH**/ ?>
            ...
            <div class="flex flex-wrap -mx-3">
                <div class="flex-none w-full max-w-full px-3">
                    <div
                        ...
                        <div class="p-6 pb-0 mb-0 bg-white border-b-0 border-b-solid rounded-t-2xl border-b-transparent flex justify-between mb-4">
                            <h6>Products table</h6>
                            <form class="" action="<?php echo e(route('admin-products-search')); ?>" method="GET">
                                <div class="flex items-center gap-4">
                                    <input class="border border-black px-4 rounded" type="search" name="query" placeholder="Search products...">
                                    <select name="category" class="border border-black px-4 rounded">
                                    ...
                                    <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                                <img style="width: 20px;height: 20px; margin: auto" src="../uploads/<?php echo e($product->img); ?>" alt="product-image">
                                            </td>
                                            <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                            ...
                                            <td class="d-flex justify-content-center gap-4 p-2 text-sm leading-normal text-center align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                                <a href="/admin/products/<?php echo e($product->id); ?>"
                                                ...
                                                <form action="/admin/products/delete" method="post">
                                                    ...
                                                    <button type="submit"
                                                            class="bg-gradient-to-tl from-green-600 to-lime-400 px-2.5 text-xs rounded-1.8 py-1.4 inline-block whitespace-nowrap text-center align-baseline font-bold uppercase leading-none text-white">delete</button>
                                                </form>
                                            </td>
                                        </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\Youcode\Documents\PHP_PROJECTS\adidas\resources\views/back/products.blade.php ENDPATH**/ ?>
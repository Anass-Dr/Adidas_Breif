            ...
            <div class="flex-none w-full max-w-full px-3">
                <div
                    ...
                    <div class="flex-auto px-0 pt-0 pb-2">
                        <form class="p-4" action="/admin/products/update" method="post" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="category_id" class="form-control" required>
                                    ...
                                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($category->id); ?>" <?php if($category->name == $product->category): ?> selected <?php endif; ?>><?php echo e($category->name); ?></option>
...
<?php /**PATH C:\Users\Youcode\Documents\PHP_PROJECTS\adidas\resources\views/back/product.blade.php ENDPATH**/ ?>
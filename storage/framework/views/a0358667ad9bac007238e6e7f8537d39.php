...
<aside
    ...
    <div class="h-19.5">
        ...
        <a class="block px-8 py-6 m-0 text-sm whitespace-nowrap text-slate-700" href="../pages/dashboard.html"
           target="_blank">
            <img src="../back/assets/img/logo-ct.png"
    ...
    <div class="items-center block w-auto max-h-screen overflow-auto h-sidenav grow basis-full">
        <ul class="flex flex-col pl-0 mb-0">
            ...
            <li class="mt-0.5 w-full">
                <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors <?php if(count($uri) > 1 && $uri[1] == 'users'): ?> shadow-soft-xl rounded-lg bg-white font-semibold text-slate-700 <?php endif; ?>"
                   href="/admin/users">
                    <div
            ...
            <li class="mt-0.5 w-full">
                <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors <?php if(count($uri) > 1 && $uri[1] == 'roles'): ?> shadow-soft-xl rounded-lg bg-white font-semibold text-slate-700 <?php endif; ?>"
                   href="/admin/roles">
                    <div
                        class="bg-gradient-to-tl from-purple-700 to-pink-500 shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
                        <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1"
            ...
            <li class="mt-0.5 w-full">
                <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors <?php if(count($uri) > 1 && $uri[1] == 'categories'): ?> shadow-soft-xl rounded-lg bg-white font-semibold text-slate-700 <?php endif; ?>"
            ...
            <li class="mt-0.5 w-full">
                <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors <?php if(count($uri) > 1 && $uri[1] == 'products'): ?> shadow-soft-xl rounded-lg bg-white font-semibold text-slate-700 <?php endif; ?>"
                   href="/admin/products">
                    <div
...
<?php /**PATH C:\Users\Youcode\Documents\PHP_PROJECTS\adidas\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>